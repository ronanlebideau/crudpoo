...
<body>
<div class="container">
    <h1>Liste des immatriculations</h1>
    <p>
...
$reponse = $bdd->query('
  SELECT proprietaires.nom AS nom, proprietaires.prenom AS prenom, immatriculation, vehicules.ID AS id
  FROM proprietaires, vehicules
  WHERE vehicules.ID_proprietaire = proprietaires.ID
